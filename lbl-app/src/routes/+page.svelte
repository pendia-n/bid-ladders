<script lang="ts">
	...
	type Deal = { id: number; listing_id: number; listing_name: string; offer: number; status: string; buyer_id: number; seller_id: number; buyer_username: string; seller_username: string; escrow_provider?: string | null; escrow_transaction_id?: string | null; escrow_status?: string | null };
